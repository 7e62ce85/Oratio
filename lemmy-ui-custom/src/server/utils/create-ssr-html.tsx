...
export async function createSsrHtml(
  ...
  console.log("BCH Config loaded:", {
    API_KEY: bchConfig.API_KEY ? `${bchConfig.API_KEY.substring(0, 3)}***` : "undefined",
    API_URL: bchConfig.API_URL,
    PAYMENT_URL: bchConfig.PAYMENT_URL
  });
